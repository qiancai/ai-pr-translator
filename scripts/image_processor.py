...
def process_all_images(added_images, modified_images, deleted_images, source_context_or_pr_url, github_client, repo_config):
    ...
    process_added_images(added_images, source_context_or_pr_url, github_client, repo_config)
    process_modified_images(modified_images, source_context_or_pr_url, github_client, repo_config)
